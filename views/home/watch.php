    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <a class="breadcrumb-item text-warning" href="/Web_HaiTrieu/home/category">Danh mục</a>
                <span class="breadcrumb-item active"><?= $c['CategoryName'] ?></span>
            </nav>
        </div>
    </div>
</div>
            ...
            <div class="row pb-3">
                <div class="col-12 pb-1">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <div>
                            <a class="btn btn-sm btn-light" href="/Web_HaiTrieu/home/watch/?id=<?= $id ?>"><i class="fa fa-th-large"></i></a>
                ...
                <div class="col-12">
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item page-prev"><a class="page-link" href="/Web_HaiTrieu/home/watch/?<?= $q ?>page=<?= $page - 1 ?>"><i class="fa-solid fa-left-long"></i></a></li>
                            <?php for ($i = 1; $i <= $pages; $i++) : ?>
                                <li class="page-item page"><a class="page-link" href="/Web_HaiTrieu/home/watch/?<?= $q ?>page=<?= $i ?>"><?= $i ?></a></li>
                            <?php endfor ?>
                            <li class="page-item page-next"><a class="page-link" href="/Web_HaiTrieu/home/watch/?<?= $q ?>page=<?= $page + 1 ?>"><i class="fa-solid fa-right-long"></i></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
...
<script>
    ...
    $($('div.navbar-nav a[href="/Web_HaiTrieu/home/watch/?id=' + id + '"]')).addClass('active');

    getFilter(
        '/Web_HaiTrieu/home/watch/?id=' + id + '&',
        ['brand', 'price'],
        '.confirm-price',
        minPrice,
        maxPrice,
