            ...
            <div class="row pb-3">
                <div class="col-12 pb-1">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <div>
                            <a class="btn btn-sm btn-light" href="/Web_HaiTrieu/home/search/?q=<?= $_GET['q'] ?>"><i class="fa fa-th-large"></i></a>
                ...
                <div class="col-12">
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item page-prev"><a class="page-link" href="/Web_HaiTrieu/home/search/?<?= $q ?>page=<?= $page - 1 ?>"><i class="fa-solid fa-left-long"></i></a></li>
                            <?php for ($i = 1; $i <= $pages; $i++) : ?>
                                <li class="page-item page"><a class="page-link" href="/Web_HaiTrieu/home/search/?<?= $q ?>page=<?= $i ?>"><?= $i ?></a></li>
                            <?php endfor ?>
                            <li class="page-item page-next"><a class="page-link" href="/Web_HaiTrieu/home/search/?<?= $q ?>page=<?= $page + 1 ?>"><i class="fa-solid fa-right-long"></i></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
...
<script>
    ...
    getFilter(
        '/Web_HaiTrieu/home/search/?q=' + '<?= $search ?>' + '&',
        ['brand', 'price'],
        '.confirm-price',
        minPrice,
        maxPrice,
